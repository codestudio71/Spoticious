...
import com.example.spoticious.MainActivity
...
class PlaybackService : Service() {
    ...
    private fun handleStop() {
        ...
        if (uri != null) {
            ...
            val fileName = if (lastState?.uri == uri) lastState.fileName else "Utwór"
    ...
    private fun buildNotification(): android.app.Notification {
        ...
        val builder = NotificationCompat.Builder(this, CHANNEL_ID)
            .setContentTitle("Spoticious")
            .setContentText(if (isPlaying) "Odtwarzanie" else "Wstrzymano")
            .setSmallIcon(android.R.drawable.ic_media_play)
            .setContentIntent(openPendingIntent)
            .setDeleteIntent(deleteIntent)
            .setVisibility(NotificationCompat.VISIBILITY_PUBLIC)
            .addAction(android.R.drawable.ic_media_previous, "Poprzedni", prevIntent)
            .addAction(
                if (isPlaying) android.R.drawable.ic_media_pause else android.R.drawable.ic_media_play,
                if (isPlaying) "Wstrzymaj" else "Odtwórz",
                playPausePendingIntent
            )
            .addAction(android.R.drawable.ic_media_next, "Następny", nextIntent)
    ...
    companion object {
        ...
        private const val CUSTOM_ACTION_STOP = "com.example.spoticious.CUSTOM_STOP"
        private const val ACTION_PLAY = "com.example.spoticious.PLAY"
        private const val ACTION_PAUSE = "com.example.spoticious.PAUSE"
        private const val ACTION_NEXT = "com.example.spoticious.NEXT"
        private const val ACTION_PREV = "com.example.spoticious.PREV"
