                ...
                Column(
                    ...
                    Row(
                        ...
                        Row(verticalAlignment = Alignment.CenterVertically) {
                            Text(
                                text = if (masterDataEnabled) "ON" else "OFF",
                    ...
                    if (masterDataEnabled) {
                        ...
                        if (masterDataLoading) {
                            ...
                            masterData?.let { md ->
                                ...
                                Text(
                                    text = masterDataError ?: "Brak danych",
...
@Composable
private fun MasterDataTable(md: com.example.spoticious.player.MasterData) {
    val headers = listOf("Peak", "Clips", "LUFS-M", "LUFS-S", "LUFS-I", "LRA")
    val values = listOf(
        md.formatPeak(),
        md.formatClips(),
        md.formatLufsM(),
...
private fun buildMetadataText(m: com.example.spoticious.player.AudioMetadata): String {
