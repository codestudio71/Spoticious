...
import com.example.spoticious.player.OutputFormat
import com.example.spoticious.player.RenderState
...
fun RenderScreen(
    ...
    playerViewModel: com.example.spoticious.player.PlayerViewModel
) {
